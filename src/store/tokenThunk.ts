...
export const fetchTokenBalance = createAsyncThunk<
   string | number,
   { tokenAddress: string; walletAddress: string; decimals: number }, // Payload type
   {}
>("tokens/fetchTokenBalance", async ({ tokenAddress, walletAddress, decimals }, { rejectWithValue }) => {
   try {
